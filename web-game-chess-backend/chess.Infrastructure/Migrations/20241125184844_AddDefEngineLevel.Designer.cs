...
namespace chess.Infrastructure.Migrations
{
    ...
    [Migration("20241125184844_AddDefEngineLevel")]
    partial class AddDefEngineLevel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("chess.Core.Entities.FriendshipStats", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("chess.Core.Entities.UserDataConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("chess.Core.Entities.UserSettings", b =>
                {
                    ...
                    b.Property<int>("DefaultEngineLevel")
                        .HasColumnType("integer");

                    b.Property<bool>("EngineGameCheats")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("chess.Core.Entities.WebGame", b =>
                {
                    ...
                    b.HasOne("chess.Core.Entities.WebGameTiming", "GameTiming")
                        .WithMany("WebGames")
