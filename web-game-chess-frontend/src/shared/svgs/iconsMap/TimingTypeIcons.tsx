  ...
  daily: (iconClass?: ElementClass, color?: ColorValue): JSX.Element => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={iconClass}>
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M12 2V4" stroke={color ? color : mainColor.c9} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M12 20V22" stroke={color ? color : mainColor.c9} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M4 12L2 12" stroke={color ? color : mainColor.c9} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M22 12L20 12" stroke={color ? color : mainColor.c9} strokeWidth="1.5" strokeLinecap="round" />
      <path
