...
const icons: PiecesMapType = {
  ...
  q: (color: string) => (
    ...
    >
      <g>
        <path
          d="M257.799,55.704c-7.706-3.866-17.016-2.36-23.111,3.734l-39.2,39.201l-38.526-86.757C153.753,4.657,146.589,0,138.683,0
       ...
       c9.933,0,18.36-7.289,19.791-17.118l17.88-122.786C269.864,67.934,265.502,59.568,257.799,55.704z"
        />
        <path
          d="M230.951,237.366H46.415c-11.046,0-20,8.954-20,20s8.954,20,20,20h184.536c11.046,0,20-8.954,20-20
  ...
  k: (color: string) => (
    ...
    >
      <g>
        <path
          d="M248.325,237.299H28.973c-11.046,0-20,8.954-20,20s8.954,20,20,20h219.353c11.046,0,20-8.954,20-20
       S259.371,237.299,248.325,237.299z"
        />
        <path
          d="M274.201,121.176c-3.999-18.229-15.083-32.794-30.412-39.961c-4.71-2.202-9.71-3.664-14.868-4.37
