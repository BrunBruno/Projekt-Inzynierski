...
import classes from "./WebGameMessages.module.scss";
...
import { webGameRightSidebarIcons } from "../WebGameRightSidebarIcons";
    ...
    <div className={classes.messages}>
      ...
      >
        ...
        <button className={classes["send-button"]} type="submit">
          <IconCreator icons={webGameRightSidebarIcons} iconName={"send"} iconClass={classes["send-svg"]} />
        </button>
      </form>
    </div>
  );
