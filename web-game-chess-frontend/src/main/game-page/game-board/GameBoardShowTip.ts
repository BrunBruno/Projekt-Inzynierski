...
class ShowTip {
    ...
    private checkPawnMove = (
        ...
        if (this.playerColor === pieceTagMap.white) {
            ...
            let [isValid, isEmpy]: boolean[] = this.isValidAndIsEmptyField(
                x,
                y
            );
    ...
    private checkPin = (
        ...
        if (this.playerColor === pieceTagMap.white) {
            ...
            if (whiteKing) {
                ...
                const pinningPiece = foundPieces.find(
                    (piece) =>
                        piece[1] === whiteKingDir &&
                        piece[0] !== pieceTagMap.white.king
                );
        ...
        if (this.playerColor === pieceTagMap.black) {
            ...
            if (blackKing) {
                ...
                const pinningPiece = foundPieces.find(
                    (piece) =>
                        piece[1] === blackKingDir &&
                        piece[0] !== pieceTagMap.black.king
                );
