...
type IconNames = "profile" | "add" | "love" | "pending" | "decline";

export const userPageIcons: IconMap<IconNames> = {
  profile: (iconClass?: ElementClass, color?: ColorValue) => (
  ...
  add: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg className={iconClass} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  love: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg className={iconClass} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  pending: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg className={iconClass} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  decline: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg className={iconClass} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
