...
import classes from "./UserGamesEmptyCard.module.scss";

type UserGamesEmptyCardProps = {};

function UserGamesEmptyCard({}: UserGamesEmptyCardProps) {
  ///
...
export default UserGamesEmptyCard;
