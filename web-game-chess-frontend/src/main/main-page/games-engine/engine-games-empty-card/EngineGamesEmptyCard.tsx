...
import classes from "./EngineGamesEmptyCard.module.scss";

type EngineGamesEmptyCardProps = {};

function EngineGamesEmptyCard({}: EngineGamesEmptyCardProps) {
  ///
...
export default EngineGamesEmptyCard;
