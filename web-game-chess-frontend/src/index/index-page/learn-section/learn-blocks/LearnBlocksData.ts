...
export const sectionData: SectionData[] = [
  {
    ...
    text:
      "Immerse yourself in the ultimate chess experience on our cutting-edge web app. Whether you're a seasoned grandmaster or just starting out, there's something for everyone. Enjoy seamless gameplay, stunning visuals, and intuitive controls. Sharpen your skills with tutorials, puzzles, and strategy guides. Connect with players worldwide, challenge friends, or join tournaments. With regular updates, the excitement never ends. Join us today for an unforgettable chess adventure!",
    iconName: "pieces-icon",
  },
  {
    title: "Unlock Your Potential",
    text:
      "Explore chess engine ratings to uncover the secrets behind your performance. Gain insights into your strengths and areas for improvement. Track your progress and set ambitious goals to climb the rating ladder. Utilize chess engines to fine-tune your strategy and optimize decision-making. Embark on a journey of self-discovery and unlock your true chess potential.",
    iconName: "counter-icon",
  },
  {
    title: "Mastering Chess with AI",
    text:
      "Harness the power of cutting-edge chess engines to dominate the board. Explore the realm of artificial intelligence, where every move leads to victory. Whether you're a novice or a seasoned player, elevate your game with the strategic prowess of AI. Analyze positions with precision, refine tactics, and challenge grandmasters. Rewrite the rules of chess mastery with the assistance of AI.",
