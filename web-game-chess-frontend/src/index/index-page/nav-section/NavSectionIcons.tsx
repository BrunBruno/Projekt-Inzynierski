...
type IconNames = "home" | "learn" | "play" | "faq";

export const navSectionIcons: IconMap<IconNames> = {
  home: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={iconClass}>
      <path
        ...
        stroke={color ? color : mainColor.c0}
        strokeLinecap="round"
  ...
  learn: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className={iconClass}>
      <path
  ...
  faq: (iconClass?: ElementClass, color?: ColorValue) => (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className={iconClass}
