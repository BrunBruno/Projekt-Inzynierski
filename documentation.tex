...
\begin{itemize}
    ...
    \item \textbf{Game}\\
    Klasa dziedziczona przez podmioty reprezentujące gry.
    \begin{longtable}{|m{4cm}|m{2cm}|m{8cm}|}
        \hline
        \textbf{Właściwość} & \textbf{Typ} & \textbf{Opis} \\ \hline
        \endhead
    ...
    Abstrakcyjna encja reprezentująca stan gry, zawierająca szczegółowe informacje, ktorych nie ma sposobu pozyskać w inny wypadku, niż poprzez zapisanie wystąpienia zdarzenia.
    \begin{longtable}{|m{4cm}|m{2cm}|m{8cm}|}
        \hline
        \textbf{Właściwość} & \textbf{Typ} & \textbf{Opis} \\ \hline
        \endhead
    ...
    \item \textbf{Move}\\
    Abstrakcyjna encja przedstawiająca ruch wykonany podczas rozgrywki.
    \begin{longtable}{|m{4cm}|m{2cm}|m{8cm}|}
        \hline
        \textbf{Właściwość} & \textbf{Typ} & \textbf{Opis} \\ \hline
        \endhead
...
\begin{itemize}
    ...
    \item \textbf{UserProfileImage i UserBackgroundImages}\\
    ...
    \begin{longtable}{|m{4cm}|m{2cm}|m{8cm}|}
        ...
        (Statystyki gier) & int & Pole zawierają dane liczbowa dotyczące statystyk gier przeprowadzonych pomiędzy użytkownikami w relacji \\ \hline
...
\newpage
\textbf{Dokumentowanie API przy użyciu Swaggera}\\
...
\textbf{Metody po stronie klienta}
...
\textbf{Wykorzystanie serwisu}\\
Serwis \textcolor{teal}{\textbf{IEngineService}} jest wykorzystywany w jednym z handlerów, służącym do zarządzania interakcją z silnikiem szachowym, który oblicza najlepszy ruch w grze na podstawie aktualnej pozycji. Handler ten pełni rolę pośrednika pomiędzy aplikacją a silnikiem, umożliwiając pobieranie ruchów zaproponowanych przez silnik. Poniżej opisano, jak serwis jest wykorzystywany w tym kontekście.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{images/ex_update_times.png}
...
Taka organizacja pozwala na modularność i łatwiejsze utrzymanie aplikacji. Każda z sekcji ma wyraźnie określoną rolę i zakres odpowiedzialności, co sprzyja porządkowi w projekcie i ułatwia dalsze rozwijanie projektu.
