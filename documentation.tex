...
\noindent
Architektura backendu oparta jest na podejściu Czystej Architektury (ang. Clean Architecture). Spopularyzowana przez Roberta Martina,  stanowi jedną z odmian architektury bazujących na zasadach Domain-Driven Design (DDD). Czysta Architektura jest szczególnie przydatna w złożonych systemach, gdzie wymagane jest ścisłe oddzielenie logiki biznesowej od aspektów technicznych. \cite{DotNetKsiazka} % źródło
